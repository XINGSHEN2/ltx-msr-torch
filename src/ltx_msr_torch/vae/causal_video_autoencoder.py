...
# Source file: comfy/ldm/lightricks/vae/causal_video_autoencoder.py
...
from ..ltx_timestep import PixArtAlphaCombinedTimestepSizeEmbeddings
from ..torch_compat import disable_weight_init, get_total_memory, intermediate_device, torch_cat_if_needed
    ...
    def __init__(
        ...
        if timestep_conditioning:
            ...
            self.last_time_embedder = PixArtAlphaCombinedTimestepSizeEmbeddings(
                output_channel * 2, operations=ops,
            )
    ...
    def forward_orig(
        ...
        if output_buffer is None:
            output_buffer = torch.empty(
                ...
                dtype=sample.dtype, device=intermediate_device(),
            )
        output_offset = [0]
